#include "shell.h"
/**
 * cd_dot - function handles the behaviour of cd
 * @datash: the directory to be changed
 * Return: void
 */
...
/**
 * cd_to - function changes the current working directory
 * @datash: parameter
 * Return:  void
 */
...
/**
 * cd_previous - function changes working directory to previous
 * @datash: parameter
 * Return: void
 */
...
/**
 * cd_to_home - function changes working directory to home
 * @datash: parameter
 * Return: void
 */
